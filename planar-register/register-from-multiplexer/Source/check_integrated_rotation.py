...
R=Path(__file__).resolve().parents[1];O=R.parent/'work/integrated-cam-development';s=(R/'Source/integrated_poses.py').read_text();exec(s)
...
for qm in [-3.75,-1.875,0,1.875,3.75]:
 for qe in [-3.75,-1.875,0,1.875,3.75]:
