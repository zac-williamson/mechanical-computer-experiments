...
This directory is the only current multiplexer design. Use the root-level STLs, Viewer.html, hardware data and Source checks here. Do not reconstruct or restore older variants unless the user asks. Do not create a second design folder when editing this design.
