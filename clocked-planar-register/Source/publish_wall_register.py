...
<dt>M–O: shared power, independent storage</dt><dd>Local input M replaces the long incoming POWER route. Shafts N and O supply opposite rotation directions to both storage clutches; the slave’s duplicate reversing pair is removed. The M and Q storage outputs remain independent. The three-gear POWER train has moved 38 mm along its shafts, away from the former bearing obstruction. Transmission bearing walls are separate parts with two spaced mounting pins each. Their exported print orientations put axle holes normal to the bed. Removable front bearing cheeks also use two joining pins. Both controller return bands are restored, and elastic loops follow their moving anchors.</dd><dt>Friction, mass and strength</dt><dd>Four plain-bearing roller followers per bit replace bare axle contact in the bellcrank slots. The bush is keyed to its axle; the axle can turn in the crank's circular hole. Crank arms have 6 mm webs and enlarged pivot bosses. Controller moving printed volume is about 29% lower; bit moving printed volume about 4% lower than the previous wall model, excluding native hardware. These are material-volume comparisons, not measured forces or strength results.</dd>
...
s=s.replace('Design and assembly notes</a>', 'Design and assembly notes</a> · <a href="Wall%20register/Flat%20frame%20printing.md">Flat frame printing</a> · <a href="Wall%20register/Axle-hole%20printing.md">Axle-hole printing</a> · <a href="Wall%20register/Friction-pin%20connections.md">Friction-pin connections</a>')
