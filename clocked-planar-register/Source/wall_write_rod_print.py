...
def separate_write_rod(g):
 ...
 bearing=s^box([-200,-30,-230],[-100,20.6,-40])
 rod=s^box([-200,26,-230],[-100,60,-40])
 bearing+=box([-155.8,15.6,z-4.8],[-136.2,25.6,z+4.8])
 rod+=box([-155.8,26,z-4.8],[-136.2,33.6,z+4.8])
 ...
 pins=[]
 for j,x in enumerate([-151.,-141.0]):
