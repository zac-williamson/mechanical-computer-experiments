...
This repository contains the current exported design assets. It does not include a self-contained parametric CAD generator; the assembly manifests and meshes are the retained editable design data. Development logs, superseded alternatives and local-machine generation scripts are excluded.
